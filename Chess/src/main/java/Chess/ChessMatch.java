...
public class ChessMatch {
    ...
    private List<Piece> piecesOnTheBosrd= new ArrayList<>();
    ...
    public ChessPiece replacePromotedPiece(String type){
        ...
        piecesOnTheBosrd.remove(p);
        
        ChessPiece newPiece = newPiece(type,promoted.getColor());
        board.placePiece(newPiece,pos);
        piecesOnTheBosrd.add(newPiece);
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece){
        ...
        if (capturedPiece != null){
            ...
            piecesOnTheBosrd.add(capturedPiece);
        }
    ...
    private ChessPiece King(Color color){
        List<Piece> list = piecesOnTheBosrd.stream().filter
    ...
    private boolean testCheck(Color color){
        ...
        List<Piece> opponentPieces = piecesOnTheBosrd.stream().filter
